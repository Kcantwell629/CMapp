	...
	if ($fn && $ln && $e && $p) { // If everything OK...
		...
		if (mysqli_num_rows($r) == 0) { // Available.
			...
			if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
				...
				// Send the email:
				$body = "Thank you for registering at CMApp. To activate your account, 
				please click on this link:\n\n";
				$body .= BASE_URL . 'activate.php?x=' . urlencode($e) . "&y=$a";
				mail($trimmed['email'], 'Registration Confirmation', $body, 'From: kcantwell629@gmail.com');
			...
			forgotten your password, use the link at right to have your password sent to you.</p>';
		}
...
<form action="register.php" method="post">
	<fieldset>
		...
		only letters, numbers, and the underscore. Must be between 4 to 20 characters long.</small></p>
